...
import { ScrollView, Image, View, Text, TextInput, StyleSheet, TouchableHighlight, TouchableOpacity, ActivityIndicator, Alert, KeyboardAvoidingView, Platform, Keyboard, TouchableWithoutFeedback } from 'react-native';
                        ...
                        <View>
                            <View style={headeratas.container}>
                                <View style={headeratas.leftContainer}>
                                    <Text style={headeratas.header}>Sign Up</Text>
                                </View>
